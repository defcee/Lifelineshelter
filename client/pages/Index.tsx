      ...
      <section className="relative py-16 md:py-24 overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <Link
              to="/programs"
              className="bg-gradient-to-br from-purple-500 to-purple-600 text-white p-8 rounded-xl border border-purple-300 hover:shadow-2xl transition-all hover:-translate-y-2 group cursor-pointer"
            >
              <div className="w-12 h-12 bg-white bg-opacity-30 rounded-lg flex items-center justify-center mb-6 group-hover:scale-110 transition-transform">
