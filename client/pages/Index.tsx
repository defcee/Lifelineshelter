      ...
      <section className="relative py-16 md:py-24 overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <Link
              to="/programs"
              className="bg-gradient-to-br from-blue-500 to-blue-600 text-white rounded-xl border border-blue-300 hover:shadow-2xl transition-all hover:-translate-y-2 group cursor-pointer overflow-hidden flex flex-col h-full"
            >
              <div className="h-40 w-full overflow-hidden">
                <img
                  src="https://images.pexels.com/photos/28101461/pexels-photo-28101461.jpeg"
                  alt="Clean water access initiative"
                  className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-300"
                />
              </div>
              <div className="p-8 flex-1 flex flex-col">
            ...
            <Link
              to="/programs"
              className="bg-gradient-to-br from-purple-500 to-purple-600 text-white rounded-xl border border-purple-300 hover:shadow-2xl transition-all hover:-translate-y-2 group cursor-pointer overflow-hidden flex flex-col h-full"
            >
              <div className="h-40 w-full overflow-hidden">
                <img
                  src="https://images.pexels.com/photos/5711236/pexels-photo-5711236.jpeg"
            ...
            <Link
              to="/programs"
              className="bg-gradient-to-br from-yellow-500 to-yellow-600 text-white rounded-xl border border-yellow-300 hover:shadow-2xl transition-all hover:-translate-y-2 group cursor-pointer overflow-hidden flex flex-col h-full"
            >
              <div className="h-40 w-full overflow-hidden">
                <img
                  src="https://images.pexels.com/photos/19263993/pexels-photo-19263993.jpeg"
                  alt="Emergency response and humanitarian relief"
                  className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-300"
                />
              </div>
              <div className="p-8 flex-1 flex flex-col">
                ...
                <p className="text-yellow-100 text-sm mb-4 flex-1">
